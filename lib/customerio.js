...
module.exports = {
  ...
  */
  track: function (customerId, eventName, properties, timestamp) {
    return when.promise(function (resolve, reject) {
      ...
      if (!_.isDate(timestamp)) {
        return reject('Please provide a valid timestamp in the fourth argument of `track`.')
      }

      // Default timestamp is now
      timestamp = unixDate(timestamp) || unixDate();
